...
# ==============================================================================
# 2. SISTEMA DE BASE DE DATOS ULTRA-LIGERO CON CACHÉ
# ==============================================================================
...
def guardar_tabla(tabla, df, columnas):
    try:
        ...
        if not df.empty:
            ...
            requests.post(f"{st.secrets['SUPABASE_URL']}/rest/v1/{tabla}", headers=get_headers(), json=df_clean.to_dict(orient="records"), timeout=10)
        st.cache_data.clear()
